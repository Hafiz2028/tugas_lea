            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="noanggota" class="col-md-4 col-form-label text-md-end">{{ __('Nomor Anggota') }}</label>

                            <div class="col-md-6">
                                <input id="noanggota" type="text" class="form-control @error('noanggota') is-invalid @enderror" name="noanggota" value="{{ old('noanggota') }}" required autocomplete="noanggota" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="notelpon" class="col-md-4 col-form-label text-md-end">{{ __('Nomor HP') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="role" class="col-md-4 col-form-label text-md-end">{{ __('Role Anggota') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="status" class="col-md-4 col-form-label text-md-end">{{ __('Status Anggota') }}</label>
